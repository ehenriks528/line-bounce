...
\subsection{The user does not need to finish the game in one sitting}
...
\subsection{Game will include a fail-soft database (not implemented)}
...
\subsection{Data storage for both client and server}
