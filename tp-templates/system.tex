...
\item Check that posts took under 5 seconds to complete (PER-07) 
\end{itemize}
\item Generate report 
\end{itemize}
...
\item Check that response took under 5 seconds to receive (PER-07) 
\end{itemize}
\item Generate report 
\end{itemize}
...
\item Check that local response took under 5 seconds to receive (PER-07) 
\end{itemize}
\item Generate report 
\end{itemize}
